  ...
  <div class="student">
    <el-tabs type="border-card">
      <el-tab-pane label="考试记录">
        <div class="main">
          ...
          <el-table :data="tableData" stripe border style="width: 100%">
            ...
            <el-table-column prop="date" label="考试时间" width="300"></el-table-column>
                ...
                >
                  ...
                  <el-form-item label="年级" prop="grade">
                    <el-select v-model="ruleForm.grade" placeholder="请选年级">
                      ...
                      <el-option label="16" value="2"></el-option>
                      <el-option label="17" value="3"></el-option>
                      <el-option label="18" value="4"></el-option>
                      <el-option label="19" value="5"></el-option>
                      <el-option label="20" value="6"></el-option>
                    </el-select>
                  </el-form-item>
      ...
      <el-tab-pane label="老师动态">
        ...
        <el-button type="primary"  @click="publish(id)">留言</el-button>
        <el-button type="danger"  @click="cand()">取消</el-button>
